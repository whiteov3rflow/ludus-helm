"""Alembic environment: wires Base.metadata and the app's DATABASE_URL into migrations."""
...
# Override the placeholder sqlalchemy.url with the real one from Settings.
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        context.configure(
            ...
            target_metadata=target_metadata,
            render_as_batch=_is_sqlite_url(config.get_main_option("sqlalchemy.url")),
        )
